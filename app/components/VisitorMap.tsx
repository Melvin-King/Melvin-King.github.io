...
export default function VisitorMap() {
  ...
  return (
    <div className="w-full flex flex-col items-center my-8 overflow-x-hidden">
      <div className="w-full max-w-[420px] mx-auto relative overflow-hidden">
        {isLoading && (
          <div className="w-full h-[220px] flex items-center justify-center border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800">
        ...
        <div 
          ref={containerRef} 
          className={`w-full min-h-[220px] max-w-full ${isLoading || hasError ? 'hidden' : 'block'}`}
        />
      </div>
    </div>
  );
